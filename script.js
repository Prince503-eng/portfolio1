...
document.getElementById("contactForm").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    const SUPABASE_URL = "https://stupacobsxkmcwzkyvvs.supabase.co";
    const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN0dXBhY29ic3hrbWN3emt5dnZzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDU0MjEyMTgsImV4cCI6MjA2MDk5NzIxOH0.ZG2EIOOuYDzLIgRRxLrBtUv5l8-jC77CMNbf0oAFyCk";
